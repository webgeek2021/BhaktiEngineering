  ...
  services: [
    {
      ...
      content:
        "Our expert 2D design services help you transform your ideas into captivating visual masterpieces, tailored to your specific requirements.",
      cardImage: [
        "../assets/gallery/photo1.png",
        "../assets/gallery/photo1.png",
      ],
    ...
    {
      title:
        "Immersive 3D Design Experience: Unleash Creativity with 3D Design",
      content:
        "Immerse yourself in the world of three-dimensional design as we bring your vision to life with our cutting-edge 3D design solutions.",
      cardImage: [
        "../assets/gallery/photo1.png",
        "../assets/gallery/photo1.png",
      ],
    },
    {
      ...
      content:
        "Unlock the potential of sheet metal with our precision-crafted designs that ensure durability and superior performance",
      cardImage: [
        "../assets/gallery/photo1.png",
        "../assets/gallery/photo1.png",
      ],
    },
    {
      ...
      content:
        "Harness the power of reverse engineering to uncover new possibilities and breathe new life into your existing components.",
      cardImage: [
        "../assets/gallery/photo1.png",
        "../assets/gallery/photo1.png",
      ],
    ...
    const card = `
        <div class="d-flex align-items-start service-page-card" id="service-card">
            ...
            <div class="paragraph-holder">
                ...
                <div class="d-flex align-items-center image-arr-container" id="image-arr-container">
                <div>${images}</div>
                <a href="./gallery.html" class="more-btn">More</a>
                </div>
            </div>
        </div>
        `;
